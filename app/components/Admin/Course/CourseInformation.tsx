        ...
        <div className="w-full flex justify-between">
          ...
          <div className="w-[50%] relative">
            ...
            <input
              type="number"
              name=""
              value={courseInfo.limitWatchedTime}
              onChange={(e: any) =>
                setCourseInfo({ ...courseInfo, limitWatchedTime: e.target.value })
              }
              id="limitTime"
              placeholder="1000"
            ...
            <span className="absolute right-2 top-[40px] text-gray-500">Hourse</span>
          </div>
        </div>
        <br />
